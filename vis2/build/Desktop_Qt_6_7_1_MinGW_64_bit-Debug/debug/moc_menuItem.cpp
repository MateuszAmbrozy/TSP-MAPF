...
struct qt_meta_stringdata_CLASSMenuItemENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSMenuItemENDCLASS = QtMocHelpers::stringData(
    "MenuItem"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSMenuItemENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject MenuItem::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSMenuItemENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSMenuItemENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSMenuItemENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *MenuItem::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSMenuItemENDCLASS.stringdata0))
